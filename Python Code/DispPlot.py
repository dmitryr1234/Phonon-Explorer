...
FileNames=[]
'''
FileNames.append("H-5.00 K 0.00 L 0.00")
FileNames.append("H-5.10 K 0.00 L 0.00")
FileNames.append("H-5.20 K 0.00 L 0.00")
FileNames.append("H-5.30 K 0.00 L 0.00")
#FileNames.append("H-5.33 K 0.00 L 0.00")
FileNames.append("H-5.40 K 0.00 L 0.00")
FileNames.append("H-5.50 K 0.00 L 0.00")
FileNames.append("H-5.60 K 0.00 L 0.00")
FileNames.append("H-5.70 K 0.00 L 0.00")
FileNames.append("H-5.80 K 0.00 L 0.00")
FileNames.append("H-5.90 K 0.00 L 0.00")
FileNames.append("H-6.00 K 0.00 L 0.00")
FileNames.append("H-6.10 K 0.00 L 0.00")
FileNames.append("H-6.20 K 0.00 L 0.00")
FileNames.append("H-6.30 K 0.00 L 0.00")
FileNames.append("H-6.40 K 0.00 L 0.00")
FileNames.append("H-6.50 K 0.00 L 0.00")
FileNames.append("H-6.60 K 0.00 L 0.00")
#FileNames.append("H-6.67 K 0.00 L 0.00")
FileNames.append("H-6.70 K 0.00 L 0.00")
FileNames.append("H-6.80 K 0.00 L 0.00")
FileNames.append("H-6.90 K 0.00 L 0.00")
FileNames.append("H-7.00 K 0.00 L 0.00")
...
'''
FileNames.append("H-4.50 K-5.50 L 0.00")
FileNames.append("H-4.60 K-5.40 L 0.00")
FileNames.append("H-4.70 K-5.30 L 0.00")
FileNames.append("H-4.80 K-5.20 L 0.00")
FileNames.append("H-4.90 K-5.10 L 0.00")
FileNames.append("H-5.00 K-5.00 L 0.00")
FileNames.append("H-5.10 K-4.90 L 0.00")
FileNames.append("H-5.20 K-4.80 L 0.00")
FileNames.append("H-5.30 K-4.70 L 0.00")
FileNames.append("H-5.40 K-4.60 L 0.00")
FileNames.append("H-5.50 K-4.50 L 0.00")
'''
...
#datasetdir='E:/Data_LSNO_120meV_'+str(T)+'K/StretchingTests100/good_slices/'
...
T=10
TxtFile=open(location_ForPlots+'Disp_bkg_T100new'+str(Temp)+'K.csv','w+')
FirstLine='0'
